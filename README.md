...
Enriches builtin Visual Studio Assets Generator by additional vector image formats (**emf, eps, psd, svg, wmf, xps**) and ability to override recommended padding (see the **"Content Width"** section).
